...
const CoreValues = () => {
  return (
    <div className="max-w-[85rem] px-4 py-2 sm:px-6 lg:px-8 lg:py-6 mx-auto" >
        ...
        <h2 className="text-2xl font-bold md:text-4xl md:leading-tight">Core Values</h2>
      </div>
      
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-12 my-5">
        ...
        <div>
          ...
          <div className="mt-5">
            <h3 className="text-lg font-bold">Crafted Expertise</h3>
            <p className="mt-1 font-light leading-relaxed">Leveraging our deep-rooted knowledge of cloud technologies, we strive to provide the most effective and cost-efficient solutions for your business.</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-5">
            ...
            <p className="mt-1 font-light leading-relaxed">A strong online presence is essential for your business. We offer reliable hosting solutions that guarantee maximum uptime and accessibility.</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-5">
            <h3 className="text-lg font-bold">Extended Support</h3>
            <p className="mt-1 font-light leading-relaxed">Our commitment to your success extends beyond the initial purchase. We offer ongoing guided support to ensure you achieve your goals.</p>
          </div>
        </div>
