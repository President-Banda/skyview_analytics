...
<div className="relative overflow-hidden">
  <div className="max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 lg:py-16 mx-auto bg-[#c0c5ce] bg-opacity-20 rounded-md">
      ...
      <div className="lg:col-span-4">
        ...
        <blockquote>
          ...
          <p className="text-xl font-medium text-gray-800 lg:text-2xl lg:leading-normal">
              What I needed was simple, an endpoint with backend code and an underlying database, no management interface, no configuration and no emails. All I did was invite the team to the repo and they set it up for me in a few hours, fully functional.
          </p>
  ...
  <div className="max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 lg:py-16 mx-auto bg-[#a7adba] bg-opacity-20 rounded-md mt-5">
    <div aria-hidden="true" className="flex -z-[1] absolute start-0">
      <div className="bg-purple-200 opacity-20 blur-3xl w-[1036px] h-[300px]"></div>
    </div>
    ...
    <div className="lg:grid lg:grid-cols-6 lg:gap-8 lg:items-center">
      ...
      <div className="lg:col-span-4">
        ...
        <blockquote>
          <Zakudimba_Logo />
          <p className="text-xl font-medium text-gray-800 lg:text-2xl lg:leading-normal">
              Switched from my previous hosting provider and never faced any issues with speed, availability nor resources, with assistance from the technical team, I never experienced an outage.
          </p>
