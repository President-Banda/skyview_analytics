...
<div class="relative overflow-hidden">
  <div class="max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 lg:py-16 mx-auto bg-[#c0c5ce] bg-opacity-20 rounded-md">
  ...
  <div class="max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 lg:py-16 mx-auto bg-[#a7adba] bg-opacity-20 rounded-md mt-5">
    <div aria-hidden="true" class="flex -z-[1] absolute start-0">
      <div class="bg-purple-200 opacity-20 blur-3xl w-[1036px] h-[300px]"></div>
    </div>
