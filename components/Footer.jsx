  ...
  return (
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto" id='contact'>
      ...
      <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14 mt-10">
        <h2 class="text-2xl font-bold md:text-4xl md:leading-tight">Contact Us Today</h2>
      </div>
      <section class="bg-gray-100">
      <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
          <div class="lg:col-span-2 lg:py-12">
            <p class="max-w-xl text-lg font-medium">
              Have other needs or require a more tailored solution? Feel free to contact us for personalized assistance. We're ready to provide prompt and expert service.
            </p>

            <div class="mt-8">
              <a href="#" class="text-2xl font-bold text-pink-600"> +265 998 34 63 03 </a>

              <address class="mt-2 not-italic">Area 47, ILilongwe, Malawi</address>
            </div>
          </div>
      ...
      <footer class="bg-white lg:grid lg:grid-cols-5 mt-2">
      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          ...
          <ul class="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" class="text-gray-700 transition hover:opacity-75"> Web Hosting</a>
            </li>

            <li>
              <a href="#" class="text-gray-700 transition hover:opacity-75"> Technical Training </a>
            </li>

            <li>
              <a href="#" class="text-gray-700 transition hover:opacity-75"> IT Consultancy </a>
            </li>

            <li>
              <a href="#" class="text-gray-700 transition hover:opacity-75"> IT Support </a>
            </li>

            <li>
              <a href="#" class="text-gray-700 transition hover:opacity-75"> Technical Writing </a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="mt-6 space-y-4 text-sm">
            ...
            <li>
              <a href="#" class="text-gray-700 transition hover:opacity-75"> Team </a>
            </li>

            <li>
              <a href="#" class="text-gray-700 transition hover:opacity-75"> Top </a>
            </li>
          </ul>
        </div>
      </div>
